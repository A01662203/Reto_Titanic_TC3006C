...
def drop_last_cols(df_train, df_test):
    ...
    df_train = df_train.drop(columns=['Ticket', 'Ticket_Number', 'Ticket_Length', 'Title', 'Name', 'TicketPrefix', 'Ticket_Group', 'Parch', 'SibSp', 'Ticket_FirstDigit'])
    ###############################################
    df_test = df_test.drop(columns=['Ticket', 'Ticket_Number', 'Ticket_Length', 'Title', 'Name', 'TicketPrefix', 'Ticket_Group', 'Parch', 'SibSp', 'Ticket_FirstDigit'])
...
# Función para juntar los datos de supervivencia al df de testeo
def merge_test_survival(df_test):
